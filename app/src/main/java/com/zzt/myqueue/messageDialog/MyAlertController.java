...
//
//    private int mButtonPanelLayoutHint = MyAlertDialog.LAYOUT_HINT_NONE;
//
...
//    }
//
//    public static final MyAlertController create(Context context, DialogInterface di, Window window) {
//        return new MyAlertController(context, di, window);
//    }
//
//    protected MyAlertController(Context context, DialogInterface di, Window window) {
//        mContext = context;
//        mDialogInterface = di;
//        mWindow = window;
...
//
//        mAlertDialogLayout = R.layout.myalert_dialog;
//        mButtonPanelSideLayout = 0;
//        mListLayout = R.layout.myselect_dialog;
//
//        mMultiChoiceItemLayout = R.layout.myselect_dialog_multichoice;
//        mSingleChoiceItemLayout = R.layout.myselect_dialog_singlechoice;
//        mListItemLayout = R.layout.myselect_dialog_item;
//        mShowTitle = true;
//
////        a.recycle();
//
...
//        }
//        if (mButtonPanelLayoutHint == MyAlertDialog.LAYOUT_HINT_SIDE) {
...
//
//    /**
//     * @see MyAlertDialog.Builder#setCustomTitle(View)
//     */
//
...
//                listView.setSelectionFromTop(checkedItem, 0);
//            }
//        }
//    }
//
